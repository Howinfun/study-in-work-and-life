 ...
 * @date 2020/8/24
 */
public class TestLengthFieldBasedFrameDecoder2 {

    public static void main(String[] args) {
        int VSRSION = 10;
        // 版本号+长度+内容
        LengthFieldBasedFrameDecoder decoder = new LengthFieldBasedFrameDecoder(1024,2,4,0,6);
